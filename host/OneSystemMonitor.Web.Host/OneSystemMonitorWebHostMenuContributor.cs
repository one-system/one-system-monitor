...
{
    public class OneSystemMonitorWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public OneSystemMonitorWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<OneSystemMonitorResource>();
